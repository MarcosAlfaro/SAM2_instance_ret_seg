...
class DatasetFSS(Dataset):
    def __init__(self, datapath, transform, split, shot):
        ...
        self.categories = sorted(self.categories) #240 categorías, 10 imgs y 10 máscaras por categoría
        self.class_ids = self.build_class_ids()
        self.img_metadata = self.build_img_metadata() #lista de 2400 rutas de imágenes
